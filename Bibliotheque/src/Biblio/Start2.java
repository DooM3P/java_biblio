...
public class Start2 {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("removeStaff fonctionne : "+ francfort.getStaff());
		...
		//Poste errone = new Poste(); // Envoie bien une exception
		...
		Emprunt pinkfloyderic = new Emprunt(paris,"FLOYD42",eric, LocalDate.of(2015, 1, 1), LocalDate.of(2022, 1, 1)); // PLUS de passages en REf
